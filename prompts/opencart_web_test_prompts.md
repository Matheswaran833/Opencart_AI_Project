...
**Application URL:** `https://tutorialsninja.com/demo/`

Implement these scenarios following the framework conventions defined in `playwright-mcp-context.md`.using playwright-cli.
...
1. Open the OpenCart login page: `https://tutorialsninja.com/demo/`.
